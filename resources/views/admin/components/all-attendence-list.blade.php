                        ...
                        <td class="px-6 py-2">
                            <div class="flex flex-col justify-center items-center gap-1">
                                @if($attendance->in_at && $attendance->out_at)
                                    <span class="bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300">Daily Basic = {{ number_format($attendance->dailySalrayAmount(), 2) }}</span>
                                    <span class="block bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300">Basic +{{ number_format($attendance->dailySalrayAmount(), 2) }}</span>
                                    <span class="block bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300">Total Overtime +{{ number_format($attendance->overtimeMoneyAmount(), 2) }} -{{ number_format($attendance->lateDeductMoneyAmount(), 2) }} -{{ number_format($attendance->earlyLeaveMoneyDeductAmount(), 2) }} = {{ number_format($attendance->todayTotalSalary(), 2) }}</span>
                                    <span class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">Late Deduct -{{ number_format($attendance->lateDeductMoneyAmount(), 2) }} -{{ number_format($attendance->earlyLeaveMoneyDeductAmount(), 2) }} = {{ number_format($attendance->todayTotalSalary(), 2) }}</span>
                                    <span class="bg-red-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300">Early Out Deduct -{{ number_format($attendance->earlyLeaveMoneyDeductAmount(), 2) }} = {{ number_format($attendance->todayTotalSalary(), 2) }}</span>
                                    <span class="block bg-purple-100 text-purple-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-purple-900 dark:text-purple-300">This Day Salary ={{ number_format($attendance->todayTotalSalary(), 2) }}</span>
                                @else 
                                    <span class="bg-gray-100 text-gray-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-full dark:bg-gray-700 dark:text-gray-300">N/A</span>
                                @endif
                            </div>
